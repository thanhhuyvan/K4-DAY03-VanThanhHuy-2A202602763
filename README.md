# Demo hiện tại: tổng hợp tin nhắn Discord

Xem [hướng dẫn demo](docs/DEMO_DISCORD.md). Chạy offline: `.\.venv\Scripts\python.exe src/app.py --provider mock --all`. Chạy AI thật: cấu hình Gemini trong `.env`, rồi dùng `--provider gemini`.

Dữ liệu demo là bản chép 4 ảnh, 16 khối tin ngày 13/09/2026; chưa đủ ngày. Nội dung bên dưới là hướng dẫn starter học vụ, tên tool và kịch bản đã được thay trong demo.
